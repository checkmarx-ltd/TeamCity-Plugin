    ...
    var SettingsForm = OO.extend(BS.AbstractPasswordForm, {
        ...
        save: function () {
            ...
            BS.PasswordFormSaver.save(this, this.formElement().action, OO.extend(BS.ErrorsAwareListener, {
                ...
                onInvalid_cxGlobalProxyHostError: function (elem) {
                    $("invalid_cxGlobalProxyHost").innerHTML = sanitizeJS(elem.firstChild.nodeValue);
                    SettingsForm.highlightErrorField($("cxGlobalProxyHost"));
                },
                onInvalid_cxGlobalProxyPortError: function (elem) {
                    $("invalid_cxGlobalProxyPort").innerHTML = sanitizeJS(elem.firstChild.nodeValue);
                    SettingsForm.highlightErrorField($("cxGlobalProxyPort"));
                },
                onInvalid_cxGlobalProxyUserError: function (elem) {
                    $("invalid_cxGlobalProxyUser").innerHTML = sanitizeJS(elem.firstChild.nodeValue);
                    SettingsForm.highlightErrorField($("cxGlobalProxyUser"));
                },
                onInvalid_cxGlobalProxyPasswordError: function (elem) {
                    $("invalid_cxGlobalProxyPassword").innerHTML = sanitizeJS(elem.firstChild.nodeValue);
                    SettingsForm.highlightErrorField($("cxGlobalProxyPassword"));
                },
...
<c:if test="${cxGlobalIsProxy != 'true'}">
    <c:set var="hideProxySection" value="style='display:none'"/>
</c:if>
...
<div>
        ...
        <form id="globalSettingsForm" action="<c:url value='/admin/checkmarxSettings.html'/>" method="post"
            ...
            <table class="runnerFormTable">
                ...
                <tr>
                    ...
                    <td>
                        <input type="password" id="cxGlobalPassword" name="cxGlobalPassword" value="${cxGlobalPassword}"
                               class="longField"/>
                ...
                <tr>
                    <th><label for="cxGlobalIsProxy">Enable Proxy</label></th>
                    <td><forms:checkbox name="cxGlobalIsProxy" value="${cxGlobalIsProxy}"
                                        checked="${cxGlobalIsProxy}"
                                        onclick="$('proxySection').toggle()"/></td>
                </tr>

                <tbody id="proxySection" ${hideProxySection}>

                <tr>
                    <th><label for="cxGlobalProxyHost">Host</label></th>
                    <td>
                        <forms:textField name="cxGlobalProxyHost" value="${cxGlobalProxyHost}"
                                         className="longField"/>
                        <span class="error" id="invalid_cxGlobalProxyHost"></span>
                    </td>
                </tr>
                <tr>
                    <th><label for="cxGlobalProxyPort">Port</label></th>
                    <td>
                        <forms:textField name="cxGlobalProxyPort" value="${cxGlobalProxyPort}"
                                         className="longField"/>
                        <span class="error" id="invalid_cxGlobalProxyPort"></span>
                    </td>
                </tr>
                <tr>
                    <th><label for="cxGlobalProxyUser">User</label></th>
                    <td>
                        <forms:textField name="cxGlobalProxyUser" value="${cxGlobalProxyUser}"
                                         className="longField"/>
                        <span class="error" id="invalid_cxGlobalProxyUser"></span>
                    </td>
                </tr>
                <tr>
                    <th><label for="cxGlobalProxyPassword">Password</label></th>
                    <td>
                        <input type="password" id="cxGlobalProxyPassword" name="cxGlobalProxyPassword"
                               value="${cxGlobalProxyPassword}"
                               class="longField"/>
                        <span class="error" id="invalid_cxGlobalProxyPassword"></span>
                    </td>
                </tr>
                <tr>
                    <th><label for="cxGlobalProxyHttps">Is Https</label>
                    </th>
                    <td><forms:checkbox name="cxGlobalProxyHttps" value="${cxGlobalProxyHttps}"
                                        checked="${cxGlobalProxyHttps}"/></td>
                </tr>
                ...
                <tr>
                    <th><label for="cxGlobalExcludeFolders">Folder Exclusion
                        <bs:helpIcon iconTitle="Comma separated list of folders to exclude from scan.</br>
                                    Entries in this list are automatically converted to exclude wildcard patterns and appended to the full pattern list provided in the advanced section"/></label>
                    </th>
                    <td><forms:textField name="cxGlobalExcludeFolders" value="${cxGlobalExcludeFolders}"
                ...
                <tr>
                    <th><label for="cxGlobalFilterPatterns">Include/Exclude Wildcard Patterns
                        <bs:helpIcon
                                iconTitle="Comma separated list of include or exclude wildcard patterns. Exclude patterns start with exclamation mark \"!\". Example: **/*.java, **/*.html, !**/test/**/XYZ*"/></label>
                    </th>
                    <td><textarea rows="5" cols="50" name="cxGlobalFilterPatterns"
                                  wrap="off">${cxGlobalFilterPatterns}</textarea>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <forms:textField name="cxGlobalScanTimeoutInMinutes" value="${cxGlobalScanTimeoutInMinutes}"
                                         className="longField"/>
            ...
            When disabled, the build step finishes after scan job submissions to Checkmarx server."/></label></th>
                    ...
                    <td colspan="2">
                        <table class="scanControlSectionTable" width="101%">
                            ...
                            <tr>
                                ...
                                <td><forms:checkbox name="cxGlobalProjectPolicyViolation"
                                                    value="${cxGlobalProjectPolicyViolation}"
                        ...
                        Leave blank for no thresholds."/></label>
                            ...
                            <tr>
                                ...
                                <td>
                                    <forms:textField name="cxGlobalHighThreshold" value="${cxGlobalHighThreshold}"
                                                     className="longField"/>
                            ...
                            <tr>
                                ...
                                <td>
                                    <forms:textField name="cxGlobalMediumThreshold" value="${cxGlobalMediumThreshold}"
                                                     className="longField"/>
                            ...
                            <tr>
                                ...
                                <td>
                                    <forms:textField name="cxGlobalLowThreshold" value="${cxGlobalLowThreshold}"
                                                     className="longField"/>
                ...
                <tr>
                    ...
                    <td>
                        <forms:checkbox name="globalDependencyScanEnabled" checked="${globalDependencyScanEnabled}"
                                        value="${globalDependencyScanEnabled}"
                ...
                <tr class="globalDependencyScanRow ">
                    ...
                    <td><textarea rows="5" cols="50" name="CxGlobalDependencyScanFilterPatterns"
                                  wrap="off">${CxGlobalDependencyScanFilterPatterns}</textarea>
                    </td>
                </tr>
                <tr class="globalDependencyScanRow">
                ...
                <tr class="globalDependencyScanRow osaInput">
                    ...
                    <td>
                        <forms:textField name="cxGlobalOsaArchiveIncludePatterns"
                                         value="${cxGlobalOsaArchiveIncludePatterns}" className="longField"/>
                    </td>
                </tr>
                <tr class="globalDependencyScanRow osaInput">
                    <th><label for="cxGlobalExecuteDependencyManager">Execute dependency managers 'install packages'
                        command before Scan
                    </label>
                    </th>
                    <td>
                        <forms:checkbox name="cxGlobalExecuteDependencyManager"
                                        checked="${cxGlobalExecuteDependencyManager}"
                                        value="${cxGlobalExecuteDependencyManager}"/>
                    </td>
                </tr>
                ...
                <tr class="globalDependencyScanRow scaInput">
                    <th><label for="cxGlobalSCAServerUrl">CxSCA server URL
                        ...
                        <l:star/></label></th>
                    <td>
                        <forms:textField name="cxGlobalSCAServerUrl" value="${cxGlobalSCAServerUrl}"
                                         className="longField"/>
                ...
                <tr class="globalDependencyScanRow scaInput">
                    <th><label for="cxGlobalSCAAccessControlServerURL">Access control server URL
                        ...
                        <l:star/></label></th>
                    <td>
                        <forms:textField name="cxGlobalSCAAccessControlServerURL"
                                         value="${cxGlobalSCAAccessControlServerURL}" className="longField"/>
                ...
                <tr class="globalDependencyScanRow scaInput">
                    <th><label for="cxGlobalSCAWebAppURL">CxSCA web app URL
                        ...
                        <l:star/></label></th>
                    <td>
                        <forms:textField name="cxGlobalSCAWebAppURL" value="${cxGlobalSCAWebAppURL}"
                                         className="longField"/>
                ...
                <tr class="globalDependencyScanRow scaInput">
                    <th><label for="cxGlobalSCAUserName">CxSCA User Name
                        ...
                        <l:star/></label></th>
                    <td>
                        <forms:textField name="cxGlobalSCAUserName" value="${cxGlobalSCAUserName}"
                                         className="longField"/>
                ...
                <tr class="globalDependencyScanRow scaInput">
                    <th><label for="cxGlobalSCAPassword">CxSCA Password
                        ...
                        <l:star/></label></th>
                    <td>
                        <input type="password" id="cxGlobalSCAPassword" name="cxGlobalSCAPassword"
                               value="${cxGlobalSCAPassword}" class="longField"/>
			...
			Example: c:\user\.m2\settings.xml, c:\user\npm\.npmrc"/>
                    ...
                    <td>
                        <textarea rows="5" cols="50" name="cxGlobalScaConfigFile"
                                  wrap="off">${cxGlobalScaConfigFile}</textarea>
                    </td>
                </tr>
                <tr class="globalDependencyScanRow scaInput">
	...
	Example: param1:value1,param2:value2"/>
                    ...
                    <td>
                        <textarea rows="5" cols="50" name="cxGlobalScaEnvVariable"
                                  wrap="off">${cxGlobalScaEnvVariable}</textarea>
                    </td>
                </tr>
...
Example of Project Full Path: CxServer/team1/projectname"/></label>
                ...
                <tr>
                    ...
                    <td>
                        <forms:textField name="cxGlobalSastServerUrl" value="${cxGlobalSastServerUrl}"
                                         className="longField"/>
                ...
                <tr>
                    ...
                    <td>
                        <forms:textField name="cxGlobalSastUsername" value="${cxGlobalSastUsername}"
                                         className="longField"/>
                ...
                <tr>
                    ...
                    <td>
                        <input type="password" id="cxGlobalSastPassword" name="cxGlobalSastPassword"
                ...
                <tr>
                    <td>
                        <form>
                            <input id="testScaSastConnection" type="button" name="TestScaSastConnection"
                ...
                <tr>
                    ...
                    <td>
                        <forms:textField name="cxGlobalOsaHighThreshold" value="${cxGlobalOsaHighThreshold}"
                                         className="longField"/>
                ...
                <tr>
                    ...
                    <td>
                        <forms:textField name="cxGlobalOsaMediumThreshold" value="${cxGlobalOsaMediumThreshold}"
                                         className="longField"/>
                ...
                <tr>
                    ...
                    <td>
                        <forms:textField name="cxGlobalOsaLowThreshold" value="${cxGlobalOsaLowThreshold}"
                                         className="longField"/>
